...
from distinct_count.flajolet_martin.flajolet_martin_extension_one import FlajoletMartinMedianEstimator


class FlajoletMartinMeanOfMedianEstimator(FlajoletMartinMedianEstimator):
    ...
    def __init__(self, sketch_size: int,
        ...
        for i in range(total_estimators):
            ...
            self.estimators.append(FlajoletMartinMedianEstimator(sketch_size=sketch_size,
